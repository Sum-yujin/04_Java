...
public class LoopEx1 {
	...
	// for(초기식; 조건식;증감식) -> 지정된 횟수 만큼 반복
	//while(조건식) -> 조건식이 false가 될 때 까지 반복
	//								 ㄴ> == 몇회인지 모르겠지만 일단 끝날때 까지 반복
