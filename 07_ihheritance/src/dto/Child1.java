...
public class Child1 extends Parent{
	...
	public void print() {
		...
		// protrcted 필드는 상속 받은 클래스에서 직접 접근 가능!!
...
//	public final void onlyparent() { }
	//The method onlyparent() of type Child1 must override or implement a supertype method
	// -> 오버라이딩 불가 에러
}
